...
TOTAL_STEPS_PER_UNIVERSE_DOMAIN_TASK = {
    ...
    'gym': {
        ...
        'Locobot': {
            ...
            'NavigationDQNGraspingRNDPerturbation': int(2e5)
        },
    },
}
...
MAX_PATH_LENGTH_PER_UNIVERSE_DOMAIN_TASK = {
    ...
    'gym': {
        ...
        'Locobot': {
            ...
            'NavigationDQNGraspingRNDPerturbation-v0': 200,
        },
    },
}
...
EPOCH_LENGTH_PER_UNIVERSE_DOMAIN_TASK = {
    ...
    'gym': {
        ...
        'Locobot': {
            ...
            'NavigationDQNGraspingRNDPerturbation-v0': 1000,
        },
    },
}
    ...
    'gym': {
        'Locobot': {
            ...
            'NavigationVacuumRNDPerturbation-v0': {
                ...
                'trajectory_log_dir': '/home/externalhardrive/mobilemanipulation/nohup_output/nav_vacuum_rnd_perturbation_newton7_14_traj/',
                'trajectory_log_freq': 1000,
                'renders': False,
                'step_duration': 0.0,
            },
            'NavigationDQNGraspingRNDPerturbation-v0': {
                'pixel_wrapper_kwargs': {
                    'pixels_only': False,
                },
                'reset_free': True,
                ...
                'steps_per_second': 2,
                'max_velocity': 20.0,
                'trajectory_log_dir': '/home/externalhardrive/mobilemanipulation/nohup_output/nav_dqn_grasping_rnd_perturbation_newton7_2_traj/',
                'trajectory_log_freq': 1000,
                'renders': False,
                'step_duration': 0.0,
